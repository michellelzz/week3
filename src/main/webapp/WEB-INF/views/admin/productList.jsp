		...
		<h2 class="title text-center">Product <strong>List</strong></h2> 
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<%
								com.Wanyu.model.Product p=(com.Wanyu.model.Product)pageContext.findAttribute("p");
								int pid=p.getCategoryId()
								java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
								String catName=com.Wanyu.model.Category.findByCategoryId(con,pid);
							%>
							<td class="cart_quantity">${p.CatName}</td>
							<td class="cart_total">
								<p class="cart_total_price"> ${p.productDescription}</p>
							</td>
							<td class="">
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productEdit?productId=${p.productName}" >
							<i class="fa fa-edit">Edit</i></a>&nbsp;
							<a class="cart_quantity_delete" href="<%=basePath%>admin/productDelete?productId=${p.productName}">
