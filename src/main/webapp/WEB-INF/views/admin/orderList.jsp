				...
				<thead>
					...
					<!-- loop_start -->
						...
						<tr>
							...
							<td>${o.orderDate}</td>
						<%
							com.Wanyu.model.Order o=(com.Wanyu.model.Order)pageContext.findAttribute("o");
							int userId=o.getCustomerId();
							java.sql.Connection con=(java.sql.Connection)application.getAttribute("con");
							com.Wanyu.dao.UserDao userDao=new com.Wanyu.dao.UserDao();
						...
						<%
							...
							String paymentType=com.Wanyu.model.Payment.findByPaymentId(con,n);
							 %>
